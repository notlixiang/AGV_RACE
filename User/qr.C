...
//	send_to_scanner(buff_set_9600);
	...
	unsigned char buff_query_baud_rate[10]={0x7e,0x00,0x07,0x01,0x00,0x0D,0x01,0xD8,0x0F};
	send_to_scanner(buff_query_baud_rate);
	
		unsigned char buff_query_output_mode[10]={0x7e,0x00,0x07,0x01,0x00,0x2A,0x02,0xab,0xcd};
